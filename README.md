...
The application stack comprises of an all-JavaScript suite of Node.js, Angular, and Socket.io. To run the application locally, complete the following steps:
